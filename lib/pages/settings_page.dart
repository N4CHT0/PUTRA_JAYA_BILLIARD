...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _saveSettings() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          // --- PERUBAHAN: Snackbar dengan tema gelap ---
            ...
            : ListView(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    // --- PERUBAHAN: Style tombol disesuaikan ---
  ...
  // --- WIDGET BARU: Helper untuk judul seksi ---
  ...
  // --- WIDGET BARU: Helper untuk TextField dengan style modern ---
